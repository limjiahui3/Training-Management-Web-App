...
//   background-color: ${(props: { primary: any; }) => (props.primary ? "#007bff" : "white")}; // Set background color based on primary prop
//   color: ${(props: { primary: any; }) => (props.primary ? "white" : "#007bff")}; // Set text color based on primary prop
...
//   &:hover {
//     background-color: ${(props: { primary: any; }) => (props.primary ? "#0056b3" : "#e9ecef")}; // Change background color on hover
//   }
// `;
